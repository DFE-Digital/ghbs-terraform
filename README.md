...
module "azure_container_apps_hosting" {
  source = "github.com/DFE-Digital/terraform-azurerm-container-apps-hosting?ref=v0.17.6"
  ...
  # postgresql_administrator_password = "ZE8r6uY9&o4&1xaR0BCBkCIVxA6Mal£w"
  # postgresql_administrator_login    = "pgadminuser"
  ...
  # 1, Postgesql with public networking
  # postgresql_network_connectivity_method = "public"
  # postgresql_public_firewall_rules = {
    "my-rule-1" = {
  ...
  # 2, Postgesql with private VNET integration, (only vnet resources can access db)
...
| <a name="input_existing_logic_app_workflow"></a> [existing\_logic\_app\_workflow](#input\_existing\_logic\_app\_workflow) | Name, Resource Group and HTTP Trigger URL of an existing Logic App Workflow. Leave empty to create a new Resource | <pre>object({<br>    name : string<br>    resource_group_name : string<br>    trigger_url : string<br>  })</pre> | <pre>{<br>  "name": "",<br>  "resource_group_name": "",<br>  "trigger_url": ""<br>}</pre> | no |
...
| <a name="input_postgresql_network_connectivity_method"></a> [postgresql\_network\_connectivity\_method](#input\_postgresql\_network\_connectivity\_method) | Specify postgres networking method, public or private. See https://learn.microsoft.com/en-gb/azure/postgresql/flexible-server/concepts-networking | `string` | `"public"` | no |
| <a name="input_postgresql_public_firewall_rules"></a> [postgresql\_public\_firewall\_rules](#input\_postgresql\_public\_firewall\_rules) | List of IP address ranges to add into the postgres firewall. Note: only applicable if postgresql\_enable\_vnet\_integration is set to false. | <pre>list(object({<br>    rule_name        = string<br>    start_ip_address = string<br>    end_ip_address   = string<br>  }))</pre> | `[]` | no |
| <a name="input_postgresql_server_version"></a> [postgresql\_server\_version](#input\_postgresql\_server\_version) | Specify the version of postgres server to run (either 11,12,13 or 14) | `string` | `"11"` | no |
